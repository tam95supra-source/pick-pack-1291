...
# Beta69 follows Beta68 code mapping. Stable stays locked at 0.1.0-stable / code 1.
g = GRADLE.read_text()
g = replace_once(
    g,
...
# Regression anchors.
assert 'versionCode = 75' in g and 'versionName = "0.4.2-beta.69"' in g
...
print('BETA69_OWNER_SIX_FIXES_PASS')
