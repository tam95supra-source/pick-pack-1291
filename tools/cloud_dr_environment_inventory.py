...
def main():
    ...
    for s in services:
        ...
        render_safe.append({"id":s.get("id"),"name":s.get("name"),"type":s.get("type"),"plan":d.get("plan") or s.get("plan"),"region":d.get("region") or s.get("region"),"suspended":s.get("suspended"),"repo":s.get("repo"),"branch":s.get("branch"),"autoDeploy":s.get("autoDeploy"),"buildCommand":d.get("buildCommand") or (d.get("envSpecificDetails") or {}).get("buildCommand"),"startCommand":d.get("startCommand") or (d.get("envSpecificDetails") or {}).get("startCommand"),"runtime":d.get("runtime"),"healthCheckPath":d.get("healthCheckPath"),"envSpecificDetails":d.get("envSpecificDetails")})
