...
if s3<0 or e3<0: raise SystemExit('Beta69 attendance section missing')
...
if s6<0 or e6<0: raise SystemExit('Beta69 timeline section missing')
...
print('BETA69_OWNER_SIX_FIXES_V4_PASS')
