...
v4=ROOT/'tools/apply_beta71_owner_requests_v4.py'
src=v4.read_text()
...
if start<0 or close<0:
    raise SystemExit('Beta71 v4 section6 delimiter anchor missing')
