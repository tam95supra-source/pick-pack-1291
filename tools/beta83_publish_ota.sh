...
jq -e --arg v "$VERSION" --arg h "$SHA" --argjson z "$SIZE" '
  ...
  .timeline_changed_fields_only==true and .employee_timeline_realtime==true and .timeline_newest_first==true and .hhmm_edit_confirmation==true and .functional_size=="320x568" and
