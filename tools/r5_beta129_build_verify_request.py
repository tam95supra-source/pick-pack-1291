...
# The exact runtime source must contain the Beta129 Android version and all R5 Service changes.
...
r.update({
  'stage':'BUILD_VERIFY',
  'mode':'BUILD_VERIFY_EXACT_SOURCE_R5',
  'version_name':'0.4.2-beta.129',
  'version_code':135,
  'base_version':old['version_name'],
  'base_version_code':old['version_code'],
  'base_source_sha':old['source_sha'],
  'base_candidate_source_sha':old.get('candidate_source_sha',old['source_sha']),
  'base_apk_sha256':old['apk_sha256'],
  'base_apk_size':old['apk_size'],
  'source_sha':source_sha,
  'candidate_source_sha':source_sha,
  'package':old['package'],
  'signer_sha256':old['signer_sha256'],
  ...
  'base_candidate_run_id':old['candidate_run_id'],
  'base_candidate_artifact_id':old['candidate_artifact_id'],
  'base_candidate_artifact_name':old['candidate_artifact_name'],
  ...
  'execution_nonce':'beta129-r5-build-verify-20260906-01',
  'next_action':'RUN_BETA129_R5_BUILD_VERIFY',
  'owner_scope':scope['scope_id'],
  'owner_scope_source':'Canonical ops/OWNER_SCOPE_CURRENT.json revision 5',
  'owner_scope_semantics_sha256':scope['semantics_sha256'],
  'owner_scope_sha256':scope['scope_sha256'],
  'owner_command_ledger_head':scope['ledger_head']['event_sha256'],
  'owner_checklist':[],
  'owner_checklist_revision':5,
  'technical_pass_requirement_numbers':[],
})
for key in [
  'candidate_run_id','candidate_artifact_id','candidate_artifact_name','apk_sha256','apk_size',
  'service_gate_run_id','service_gate_artifact_id','service_gate_artifact_name','service_gate_inherited_reason',
  'fast_check_run_id','verify_run_id','verify_artifact_id','verify_artifact_name',
  'pda_functional_run_id','pda_functional_artifact_id','back_api36_run_id','back_api36_artifact_id',
  'device_regression_run_id','device_regression_artifact_id','service_discovery_run_id',
  'runtime_dod_run_id','runtime_dod_artifact_id','runtime_dod_artifact_name','publish_run_id','ota_readback_run_id'
]: r.pop(key,None)
