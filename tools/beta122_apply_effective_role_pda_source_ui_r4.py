...
# The source has two direct HISTORY routes; guard both with effective role.
...
# pdaSelectedPanel is immediately followed by naturalUserCompare in the canonical source.
pstart=src.index("panel_pat=re.compile")
pend=src.index("# Autocomplete labels show source.", pstart)
